...
rem Run DimensionManagementServiceTest.class
...
rem Build the CLASSPATH required to run DimensionManagementServiceTest.class
...
set CLASSPATH=%CLASSPATH%;%JAR_HOME%/commons-httpclient.jar
...
rem Run DimensionManagementServiceTest.class
"%JAVA_HOME%" -classpath %CLASSPATH% DimensionManagementServiceTest

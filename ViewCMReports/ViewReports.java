...
public class ViewReports
{
	...
	*
	* @return  	Returns a string that either shows the name of each report 
	*          	or query in the content store, or displays a message to 
	*          	indicate that there are no reports or queries to show. 
	*/
	...
	public String viewReportsAndQueries(CRNConnect connection)
	{
		...
		if (connection.getCMService() != null)
		{
			...
			try
			{
				...
				* 
				* @param   "/content//report"
				*          Specifies the search path string so that Content Manager 
				*          can locate the requested objects, which are reports in 
				*          this example.
				* @param   props
				*          Specifies alternate properties that you want returned for 
				*          the report object. 
				*          When no properties are specified, as in this example, the 
				*          default properties of searchPath and defaultName are 
				*          provided.
				* @param   sortOptions
				...
				*/
				...
				// If reports exist in the content store, the output shows the report 
			...
			{
				/**
				* Use this ReportNet method to query the query objects in the content 
				* store. Query objects are created when users save reports that they 
				* create using Query Studio.
				* 
				* @param   "/content//query"
				*          Specifies the search path string so that Content Manager 
				*          can locate the requested objects, which are queries in 
				*          this example.
				* @param   props
				*          Specifies alternate properties that you want returned for 
				*          the query object. 
				*          When no properties are specified, as in this example, 
				*          the default properties of searchPath and defaultName are 
				*          provided.
				* @param   sortOptions
				*          Specifies the sort criteria in an array.
				* @param   QueryOptions

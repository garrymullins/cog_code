 ...
 */
public class JDBCSample extends Namespace implements INamespaceAuthenticationProvider2
{
	 ...
	 */
	public IVisa logon(final IBiBusHeader2 theAuthRequest) throws UserRecoverableException, SystemRecoverableException,

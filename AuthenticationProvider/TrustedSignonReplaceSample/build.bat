...
rem Build Java files in directory TrustedSignonReplaveSample

echo Building TrustedSignonReplaceSample

rem Build the CLASSPATH required to build Java files in the directory TrustedSignonReplaceSample
...
rem Create jar file
jar cfm0 TrustedSignonReplaceSample.jar MANIFEST *.class

...
public class API /* implements ReportBuilder */
{
		...
		try
		{
			...
			if (index >= 0)
			{
				start = sReportSpec.substring(0, index);
						...
						"http://developer.cognos.com/schemas/report/14.1/") + 49);
	...
	public API() {
		...
		reportElement.addNamespace("", "http://developer.cognos.com/schemas/report/14.1/");
	...
	public void updateXMLNS() {
		...
		// In dom4j 1.6.1, can no longer add xmlns with addAttribute
		e.addNamespace("", "http://developer.cognos.com/schemas/report/14.1/");
	}

...
// display a window.
public class ViewAllUI extends JFrame
{
	...
	public ViewAllUI(String title, CRNConnect connection)
	{
	...
	private void addComponents()
	{
		...
		viewAllButton.addActionListener(new allButtonsHandler());
		JPanel buttonPanel = new JPanel();
		buttonPanel.add(viewAllButton, BorderLayout.EAST);
			...
			try
			{
				...
				if (menuClicked.getText().compareTo("Overview") == 0)
				{
					JFrame explainWindow =
						new JFrame("Overview for View All Sample");
					File explainFile = new File("Java_ViewAllUI_Explain.html");
	...
	private class allButtonsHandler implements ActionListener
	{
		public void actionPerformed(ActionEvent e)
		{
			...
			if (buttonPressed == viewAllButton)
			{
				ViewPackagesAndReports packages = new ViewPackagesAndReports();
				output = packages.viewAll(connect);
			}
	...
	public static void main(String args[])
	{
		...
		ViewAllUI frame = new ViewAllUI("IBM Cognos Sample", connection);

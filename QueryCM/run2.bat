...
rem Run cmQueryUI.class

rem Relative definitions based on ReportNet installation location.
...
rem Build the CLASSPATH required to run cmQueryUI.class
...
rem Run cmQueryUI.class
"%JAVA_HOME%" -classpath %CLASSPATH% cmQueryUI

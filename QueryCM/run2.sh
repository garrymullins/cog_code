...
# Build the CLASSPATH required to run cmQueryUI.class
...
CLASSPATH="$CLASSPATH:../Common:../HandlersCS:../Security"
# Go!
#
# CHANGE the arguments unless you want to run using the defaults.
$JAVA -classpath "$CLASSPATH" cmQueryUI
